...
randomIcon = document.getElementById("random"),
...
const music_list = [
    {
        img : 'images/Letgo.jfif',
        name : 'Let Go',
        artist : 'Central Cee',
        music : 'music/Central Cee-Let Go.mp3'
    },
    {
        img : 'images/woah.jfif',
        name : 'Woah',
        artist : 'Lil Baby',
        music : 'music/Lil Baby-Woah.mp3'
    },
    {
        img : 'images/wepaid.jfif',
        name : 'We Paid',
        artist : 'Lil Baby, 42 Dugg',
        music : 'music/Lil Baby x 42 Dugg  We Paid.mp3'
    },
    {
        img : 'images/Tomorrow2.jfif',
        name : 'Tomorrow 2',
        artist : 'GloRilla, Cardi B',
        music : 'music/GloRilla Cardi B-Tomorrow 2.mp3'
    },
    {
        img : 'images/AHHHHA.jfif',
        name : 'AHHH HA',
        artist : 'Lil Durk',
        music : 'music/Lil Durk  AHHH HA.mp3'
    }
];
